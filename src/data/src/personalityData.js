...
var list3 = [{
  subject: '当你要在一个星期内完成一个大项目，你在开始的时候会',
  answer: '',
  option: [{ key: 'A', label: '把要做的不同工作依次列出', value: 'E' }, { key: 'B', label: '马上动工', value: 'I' }]
}, {
  subject: '在社交场合中，你经常会感到',
  answer: '',
  option: [{ key: 'A', label: '与某些人很难打开话匣儿和保持对话', value: 'E' }, { key: 'B', label: '与多数人都能从容地长谈', value: 'I' }]
}, {
  ...
  subject: '你认为按照程序表做事 ',
  answer: '',
  option: [{ key: 'A', label: '有时是需要的，但一般来说你不大喜欢这样做', value: 'E' }, { key: 'B', label: '大多数情况下是有帮助而且是你喜欢做的', value: 'I' }]
}, {
  ...
  subject: '你会 ',
  answer: '',
  option: [{ key: 'A', label: '跟随一些证明有效的方法', value: 'E' }, { key: 'B', label: '分析还有什么毛病，及针对尚未解决的难题', value: 'I' }]
}, {
  subject: '为乐趣而阅读时，你会 ',
  answer: '',
  ...
  subject: '你是否 ',
  answer: '',
  option: [{ key: 'A', label: '可以和任何人按需求从容地交谈', value: 'E' }, { key: 'B', label: '只是对某些人或在某种情况下才可以畅所欲言', value: 'I' }]
}, {
